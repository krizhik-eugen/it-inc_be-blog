...
export const postsQueryRepository = {
    async getPosts(req: TGetAllPostsRequest): Promise<AllItemsViewModel<PostViewModel>> {
    ...
    async getBlogPosts(req: TGetAllBlogPostsRequest): Promise<AllItemsViewModel<PostViewModel> | undefined> {
